...
import time
import pickle
x_cols = ['pickup_hour', 'Condition', 'Precip', 'Precip_Accum', 'pickup_dayofweek', 'PULocationID']
...
mape_train_list = []
mape_val_list = []
for sub_data in pd.read_csv(train_file, chunksize=800000):
    ...
    i += 1
filename = '../model/withweather/incre_gbm_count.sav'
